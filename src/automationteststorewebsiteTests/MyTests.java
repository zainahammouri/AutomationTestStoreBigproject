...
//	check The homepage loads completely, displaying all primary elements such as navigation menus, banners, and featured products.
	...
	@Test(priority = 2)
	public void UserRegistrationTest() throws SQLException, InterruptedException {
	...
	@Test(priority = 6)
	public void FilteringSearchResultsTest() {
	...
	public void ViewingProductDetailsTest() {
	...
	@Test(priority = 9)
	public void ViewingAndModifyingtheShoppingCart() {
